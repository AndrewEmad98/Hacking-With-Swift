...
class ViewController: UITableViewController {
    ...
    func loadUserData(){
        ...
        if let baseWord = defaults.string(forKey: "baseWord"){
            title = baseWord
        }
        if let data = defaults.object(forKey: "usedAnagrams") as? [String]{
            usedWords = data
        }
    }
    ...
    func saveUserData(){
        let defaults = UserDefaults.standard
        defaults.set(title,forKey: "baseWord")
        defaults.set(usedWords,forKey: "usedAnagrams")
    }
